  ...
  return tutInfo ? (
    <div className="p-6 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row gap-6">
        ...
        <div className="flex-1 border border-[#ADADAD] rounded-lg p-8 bg-white relative shadow-lg">
      ...
      <div className="border border-gray-300 rounded-lg p-6 bg-white shadow-lg text-center">
        ...
        {/* Time Slots */}
        <div className="flex items-center justify-center gap-4 overflow-x-auto mt-6">
          {tutSlots.length > 0 &&
        ...
        {/* Button */}
        <button onClick={bookAppointment} className="bg-blue-400 text-black text-sm font-medium px-8 py-3 rounded-lg mt-6 hover:bg-blue-400-dark transition-all duration-300">
          Book an Appointment
        </button>
      </div>
    </div>
