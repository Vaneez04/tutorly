    ...
    return userData && (
        <div className='max-w-lg flex flex-col gap-2 text-sm pt-5'>
            ...
            <div className='mt-10'>
                ...
                {isEdit
                    ? <button onClick={updateUserProfileData} className='border border-blue-400 px-8 py-2 rounded-full hover:bg-blue-border-blue-400 hover:text-pink-900 transition-all'>Save information</button>
                    : <button onClick={() => setIsEdit(true)} className='border border-blue-400 px-8 py-2 rounded-full hover:bg-blue-border-blue-400 hover:text-pink-900 transition-all'>Edit</button>
                }
